...
lapply(c("plyr","dplyr","ggplot2","cowplot","lubridate","parallel",
         ...
         "Metrics","MCMCglmm","wesanderson"), require, character.only=T)
...
pal <- wes_palette(name="Zissou1",n=9, type="discrete")

ggplot(PM3_IN_OUT, aes(input_value, ParOutput_med, color=short_name))+
    ...
    geom_point(size=4)+
    labs(x = "Input Parameter Values", y="Median Posterior Values",title="PM3: Ricker")+
    ...
    #scale_size_manual(name="",values=c('s'=2, 'c'=2,'r'=2,'sig_p'=2,'lambda'=2),
    #                   labels=)
