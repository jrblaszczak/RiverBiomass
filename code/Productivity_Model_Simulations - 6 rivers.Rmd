---
title: "Productivity Model Simulations - 6 rivers"
...
PM_outputlist_AR <- lapply(stan_data_l, function(x) stan("Stan_ProductivityModel1_Autoregressive.stan", data=x,chains=3,iter=5000, control=list(max_treedepth=12))) #5394 seconds
saveRDS(PM_outputlist_AR, "stan_6riv_output_AR.rds") 
## PM 2 - Logistic
PM_outputlist_Logistic <- lapply(stan_data_l, function(x) stan("Stan_ProductivityModel2_Logistic.stan", data=x,chains=3,iter=5000, control=list(max_treedepth=12)))
saveRDS(PM_outputlist_Logistic, "stan_6riv_output_Logistic.rds")
## PM 3 - Ricker
...
saveRDS(PM_outputlist_Ricker, "stan_6riv_output_Ricker.rds")
## PM 4 - Gompertz
...
saveRDS(PM_outputlist_Gompertz, "stan_6riv_output_Gompertz.rds")
