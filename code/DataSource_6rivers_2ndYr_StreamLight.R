...
## Second Year - within sample prediction
...
data_siteyears <- data %>%
  ...
  tally()
## Select the second of two years
data <- rbind(data[which(data$site_name == "nwis_02336526" & data$year %in% c(2016)),],
              data[which(data$site_name == "nwis_01649190" & data$year %in% c(2011)),],
              data[which(data$site_name == "nwis_07191222" & data$year %in% c(2010)),],
              data[which(data$site_name == "nwis_01608500" & data$year %in% c(2013)),],
              data[which(data$site_name == "nwis_11044000" & data$year %in% c(2016)),],
              data[which(data$site_name == "nwis_08447300" & data$year %in% c(2013)),])
