...
LG_params <- c("r","beta_0","s","c","B","P","pred_GPP","sig_p")
LG_mult_site_par_1 <- lapply(PM.Ricker_l_1to5, function(x) extract(x, LG_params))
LG_mult_site_par_2 <- lapply(PM.Ricker_l_6to10, function(x) extract(x, LG_params))
