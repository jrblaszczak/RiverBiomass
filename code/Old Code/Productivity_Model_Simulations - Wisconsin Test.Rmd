---
title: "Productivity Model Simulations - Wisconsin Test"
...
plot_grid(
 ggplot(df, aes(date, GPP))+
  ...
  ggplot(df, aes(date, tQ*1))+geom_point(size=2, color="deepskyblue4")+
...
PM2b_DataOutput <- stan("Stan_ProductivityModel2b_Logistic.stan", data=stan_data, chains=4, iter=1000)
