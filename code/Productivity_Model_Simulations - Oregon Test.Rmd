...
# gap fill days with missing turb
df$light_turb <- na.approx(df$light_turb, maxgap = 2)
...
source("Simulated_ProductivityModel4_Ricker_lightadj.R") # estimated parameters: alpha, lambda, s, c, sig_p
source("Simulated_ProductivityModel5_Gompertz.R") # estimated parameters: alpha, lambda, s, c, sig_p
```
...
# View on shiny
launch_shinystan(PM3_DataOutput) ## Click explore tab when new window opens
# Save Output
saveRDS(PM1_DataOutput,"PM1_DataOutput.rds")
saveRDS(PM2_DataOutput,"PM2_DataOutput.rds")
saveRDS(PM3_DataOutput,"PM3_DataOutput.rds")
