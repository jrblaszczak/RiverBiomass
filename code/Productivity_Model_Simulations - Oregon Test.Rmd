...
# source simulation models with benthic light
source("Simulated_ProductivityModel1_Autoregressive_BenthicL.R") # parameters: phi, alpha, beta, sig_p
source("Simulated_ProductivityModel2_Logistic_BenthicL.R") # parameters: r, K, s, c, sig_p
source("Simulated_ProductivityModel3_Ricker_BenthicL.R") # parameters: r, lambda, s, c, sig_p
source("Simulated_ProductivityModel4_Ricker_lightadj_BenthicL.R") # parameters: alpha_0, alpha_1, lambda, s, c, sig_p
source("Simulated_ProductivityModel5_Gompertz_BenthicL.R") # parameters: beta_0, beta_1, beta_2, s, c, sig_p
