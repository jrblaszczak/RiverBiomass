...
## PM 3 - Ricker
PM_outputlist_Ricker <- lapply(stan_data_l[1:2], function(x) stan("Stan_ProductivityModel3_Ricker.stan", data=x,chains=3,iter=5000, control=list(max_treedepth=12))) #84 seconds
