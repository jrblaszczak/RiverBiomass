...
stan_data_l_new <- lapply(dat[c("nwis_01645762","nwis_01649190","nwis_04137500")], function(x) stan_data_compile(x))
...
## PM 3 - Ricker
PM_outputlist_Ricker <- lapply(stan_data_l_new, function(x) stan("Stan_ProductivityModel3_Ricker.stan", data=x,chains=3,iter=5000, control=list(max_treedepth=12))) #84 seconds
saveRDS(PM_outputlist_Ricker, "./rds files/stan_3newriv_output_Ricker.rds")
## PM 4 - Gompertz
