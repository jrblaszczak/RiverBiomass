...
#### Model 1: Linear autoregressive model
...
\begin{equation} 
G_{pred,t} = \phi G_{pred,(t-\triangle t)} + \alpha L_{t} + \beta Q_{t}
\end{equation}
...
#### Model 2: Latent biomass logistic growth
...
#### Model 3: Latent biomass thin film growth (density independent growth, density dependent death)
...
### OTHER TEXT TO BE INCOPORATED

Process error ($\sigma_{p}$), $r_{max}$, $\beta_r$, and $K$ have weakly informative priors based on a truncated (half) normal distribution:
