##==============================================================================
## Script for within-sample fit biomass hysteresis
...
######################################################################
## Find storm hysteresis curves in GPP and latent biomass
######################################################################
...
## Combine
preds <- merge(lbts_GPP, df_modB3, by=c("site_name","Date"))
